...
var stellaDB_1 = __importDefault(require("./stellaDB"));
var webapp_helper_1 = require("./webapp.helper");
/**
 * [Memo description]
 ...
 * @constructor
 */
var Memo = function Memo(nome_db, nomi_tabelle, indexes) {
    ...
    this.uuid = uuid_1.default; // Funzione per creare identificativo unico
    var indexedDB_supportato = typeof indexedDB_1.default === "object" && indexedDB_1.default.compat;
    ...
    var suPronto = function () { this.sonoPronto = true; this._esegui_suPronto(this); }.bind(this);
    if (indexedDB_supportato) {
        indexedDB_1.default.apri(this.nome_db).then(function () { iniz_tabelle.bind(this)(nomi_tabelle, suPronto, indexes); }.bind(this));
        this.db = indexedDB_1.default;
    }
    else {
        this.db = new stellaDB_1.default(this.nome_db);
...
Memo.prototype.autocrea_tabella = function (nome_tabella, suFinito, indexes) {
    ...
    if (!this.db.essisteTabella(nome_tabella)) {
        if (this.db.macchina === "stellaDB") {
            stellaDB_1.default.creaTabella(this.nome_db, nome_tabella);
            suFinito();
        }
        else { // indexedDB
...
Memo.prototype.update = function (nome_tabella, id_unico, valori) {
    ...
    return new Promise(function (resolve, reject) {
        _this.seleziona(nome_tabella, {
            field: _this.unico_chiave,
            valore: id_unico
        }).then(function (rige) {
            if (rige.length > 1) {
...
if (typeof stellaDB_1.default !== "function" && typeof indexedDB_1.default !== "object") {
    alert("memo.js ha bisogno di stellaDB o indexedDB (iDB) per funzionare!");
}
if (typeof webapp_helper_1.JSONparseNums !== "function") {
